    ...
    with ui.dialog() as dialog, ui.card().classes(
        ...
        def generate_teeth_svg(
            ...
            for tooth_id, x, y, w, h in teeth_data:
                ...
                is_active = tooth_id in current_selection
        ...
        def handle_tooth_click(e):
            ...
            if tooth_id in current_selection:
                current_selection.remove(tooth_id)
            else:
                current_selection.add(tooth_id)
        ...
        def open_with_teeth(initial_teeth):
            ...
            img_primary.set_visibility(has_primary)

            refresh_svg_layers()
            dialog.open()

        dialog.open_with_teeth = open_with_teeth
        ...
        with ui.row().classes("w-full justify-end mt-4 gap-2"):
            ...
            ui.button(
                ...
                color="primary",
                on_click=lambda: [
                    on_save_callback(current_selection),
                    dialog.close(),
                ],
            )
